        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                RotationTransition(
                  ...
                  turns: Tween<double>(begin: -0.09, end: 0.005).animate(
                      CurvedAnimation(
                          parent: welcomeService.wavingAnimation,
            ...
            Column(
              ...
              children: [
                Text(
                  welcomeService.currentGreeting,
                ...
                Row(
                    ...
                    children: [
                      const Icon(PersonalPortfolioIcons.badge,
                          color: PersonalPortfolioColors.lightBlue, size: 80),
